...
class IncrementalPersonReIDSamples:
    def __init__(self, train, query, gallery, **kwargs):
        self.pid_list = self.get_pids_list(train)
        self.num_train_pids = len(self.pid_list)
        self.num_train_cams = self.get_num_cams(train)
        self.num_datasets = self.get_num_datasets(train)
