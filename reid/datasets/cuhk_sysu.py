...
class CUHK_SYSU(BaseImageDataset):
    ...
    # dataset_dir = '/home/wenhang/data/cuhksysu4reid'
    # dataset_dir = '/home/huangjinze/data/REID/cuhk-sysu/cuhksysu4reid'
    # dataset_dir = '/root/autodl-nas/REID/cuhk-sysu/cuhksysu4reid'

    def __init__(self, root, verbose=True, **kwargs):
        super(CUHK_SYSU, self).__init__()
        self.domain_id = kwargs['domain_id']
        self.dataset_dir = osp.join(root, 'cuhksysu4reid')
    ...
    def _process_dir(self, dir_path, relabel=False,query=False):
        ...
        for img_path in img_paths:
            ...
            if query:
                dataset.append((img_path, pid, 1, self.domain_id))
            else:
                dataset.append((img_path, pid, 0, self.domain_id))
