...
# class BaseVisdomLogger(BaseLogger):
#     '''
...
#
#
# def plot_dict(visdom_result_dict, visdom_dict, global_current_epoch, current_step, port, env_name):
...
#         else:
#             visdom_dict[name] = VisdomPlotLogger('line', port=port, env=env_name,
