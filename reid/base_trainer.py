...
class Trainer(object):
    def __init__(self, model, num_classes, loss_items, margin=0.0):
    ...
    def train(self, epoch, data_loader_train, data_loader_replay, optimizer, training_phase,
        ...
        print(f"starting train stage: {training_phase} with {epoch} epoches for {train_iters} iters")
        ...
        return {
            'losses_ce': losses_ce.avg,
            'losses_tr': losses_tr.avg,
            'losses_kd_r': losses_kd_r.avg,
            'losses_DCL': losses_DCL.avg,
            'losses_PT_ID': losses_PT_ID.avg,
            'losses_PT_KD': losses_PT_KD.avg,
        }
